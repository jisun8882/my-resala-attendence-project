        ...
        <div class="contentDiv">
            ...
            <!-- InstanceBeginEditable name="contentRegion" -->
                ...
                <div class="optionsDiv">
                    <a class="adminsOptionA" href="editVolMonRep.php"><h3>تعديل الملاحظات الشهرية</h3></a><br />
                    <a class="adminsOptionA" href="deleteVolMonRep.php"><h3>حذف جميع الملاحظات الشهرية</h3></a>
				</div>
        	<!-- InstanceEndEditable -->
