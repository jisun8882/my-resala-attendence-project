        ...
        <div class="contentDiv">
            ...
            <!-- InstanceBeginEditable name="contentRegion" -->
                ...
                <div class="optionsDiv">
                    <a class="adminsOptionA" href="addVolunteer.php"><h3>إضافة متطوع جديد</h3></a> <br />
                    <a class="adminsOptionA" href="editVolunteer.php"><h3>تعديل بيانات متطوع</h3></a> <br />
                    <a class="adminsOptionA" href="deleteVolunteer.php"><h3>حذف متطوع</h3></a>
				</div>
        	<!-- InstanceEndEditable -->
