        ...
        <div class="contentDiv">
            ...
            <!-- InstanceBeginEditable name="contentRegion" -->
                ...
                <div class="VoloptionsDivS">
					...
					echo "<tr>";
					echo "<th>حزف</th> <th>يعمل</th> <th>المعاد الثانى</th> <th>المعاد الاول</th> <th>الموبيل</th> <th>الاسم</th> <th>المادة</th>";
					echo "</tr>";
					...
					while($row = mysql_fetch_array($getStudentquery)  ){
						...
						echo "<input name='stuffID' type='hidden' value='".$row['stuff_id']."' /><input type='submit' value='حذف' />";
						echo "</td>";
