        ...
        <div class="contentDiv">
            ...
            <!-- InstanceBeginEditable name="contentRegion" -->
                ...
                <div class="optionsDiv">
                    <a class="adminsOptionA" href="addStudent.php"><h3>أضافة طالب جديد</h3></a> <br />
                    <a class="adminsOptionA" href="editStudent.php"><h3>تعديل بيانات طالب</h3></a> <br />
                    <a class="adminsOptionA" href="deleteStudent.php"><h3>حذف طالب</h3></a>
				</div>
