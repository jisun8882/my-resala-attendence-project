        ...
        <div class="contentDiv">
            ...
            <!-- InstanceBeginEditable name="contentRegion" -->
                ...
                <div class="optionsDiv">
                    <a class="adminsOptionA" href="createStrategy.php"><h3> أنشاء خطة شهرية جديدة</h3></a> <br />
                    <a class="adminsOptionA" href="editStrategy.php"><h3>تعديل الخطة الشهرية</h3></a><br />
                    <a class="adminsOptionA" href="deleteStrategy.php"><h3>حذف الخطة الشهرية</h3></a>
				</div>
