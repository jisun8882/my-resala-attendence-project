        ...
        <div class="contentDiv">
            ...
            <!-- InstanceBeginEditable name="contentRegion" -->
        		<h2> <marquee direction="right">
                    <font style="color:#090">مرحباً بكم</font>
                    <font style="color:#03F">فى</font>
                    <font style="color:#090">دروس</font>
                    <font style="color:#03F">تقويه</font>
                    <font style="color:#090">رسالة</font>
                    <font style="color:#03F">فرع</font>
                    <font style="color:#090">المعادى</font>
                </marquee> </h2>
