        ...
        <div class="contentDiv">
            ...
            <!-- InstanceBeginEditable name="contentRegion" -->
                ...
                <div class="VoloptionsDiv">
					...
					echo "<tr>";
					echo "<th>تعديل</th> <th>يعمل</th> <th>المعاد الثانى</th> <th>يعمل</th> <th>المعاد الاول</th> <th>الموبيل</th> <th>الاسم</th> <th>المادة</th>";
					echo "</tr>";
					...
					while($row = mysql_fetch_array($getStudentquery)  ){
						...
						<input type='submit' class='btn' value='عدل' />";
						echo "</td>";
