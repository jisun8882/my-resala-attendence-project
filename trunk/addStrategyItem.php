            ...
            <!-- InstanceBeginEditable name="contentRegion" -->
                ...
                <div class="VoloptionsDiv">
                    ...
                    <form action="addStrategyItem1.php" method="post" name="addItem">
                        ...
                        <tr>
                            <td colspan="2">
                            <input name="body" type="text" size="80" style="text-align:right" autocomplete="off" />: الخطة </td>
                        </tr>
                        <tr>
                            <td align="right">
                            <?php
                        ...
                        <tr>
                            <td><input type="submit" class="btn btn-primary" name="submit" value="أضافة" /></td>
                            <td>&nbsp;</td>
                        </tr>
                        </table>
					</form>
