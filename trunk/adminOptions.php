        ...
        <div class="contentDiv">
            ...
            <!-- InstanceBeginEditable name="contentRegion" -->
				<div class="optionsDiv">
                    <a class="adminsOptionA" href="studentOption.php"><h3>طلاب</h3></a> <br />
                    <a class="adminsOptionA" href="volunteerOption.php"><h3>متطوعين</h3></a> <br />
                    <a class="adminsOptionA" href="scheduleOption.php"><h3>جداول</h3></a> <br />
				</div>
        	<!-- InstanceEndEditable -->
