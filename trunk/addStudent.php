                    ...
                    <p>
                        ...
                        <form action="" method="post">
                            <table width="auto" border="0">
                                <tr>
                                    <td>(*)<input name="f_name" type="text" size="20">: الاسم الاول</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td><input name="m_name" type="text" size="20">: الاسم الاوسط</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>(*)<input name="f_name" type="text" size="20">: الاسم الاخير</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                </tr>
                                <tr>
                                    <td>(*)<input name="mobile" type="text" size="25">: الموبيل</td>
                                </tr>
                                <tr>
                                    <td>&nbsp;</td>
                                </tr>
